...
<body style="background-color: #ECD6C0;">
    <header style="background-color: #BF9780; padding: 10px; font-size: 20px;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div>
                <h2 style="font-size: 76px;">Catalago de Productos</h2>
            </div>
            <div>
    ...
    <div style="display: flex; align-items: center;">
        ...
        <div class="categoria-barNIÑOS categoria-bar-textNIÑOS">Catalago</div>
    ...
    <div class="container">
        ...
        // Consulta SQL para recuperar los productos con los nombres de categoría
        $sql = "SELECT Producto.id, Producto.nombre, Producto.precio, Producto.cantidad_stock, Categoria.nombre AS categoria_nombre FROM Producto
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<table>";
            echo "<tr><th>ID</th><th>Nombre</th><th>Precio</th><th>Cantidad en Stock</th><th>Categoría</th><th>Acciones</th></tr>";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<td>
                    <a href="editarproducto.php?id=' . $row["id"] . '"><i class="fas fa-edit"></i></a>
                    <a href="eliminarproducto.php?id=' . $row["id"] . '"><i class="fas fa-trash"></i></a>
                </td>';
