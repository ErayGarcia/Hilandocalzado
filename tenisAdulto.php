...
<body style="background-color: #ECD6C0;">
    <header style="background-color: #BF9780; padding: 10px; font-size: 20px;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div>
                ...
                <br>
                <a href="Adultos.php"><button class "circular-button" style="background-color: #FFFFEB; font-size: 20px;">Almacen</button></a>
            </div>
        </div>
    </header>
    <br>
    <div style="display: flex; align-items: center; justify-content: space-between; padding: 0 20px;">
        ...
        <a href="nosotros.php"><button class="circular-button button-almacen">Nosotros</button></a>
    </div>
    <br>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div style="text-align: center; margin-top: 30px; margin: 30px; ">
                    ...
                    <a href="carrito.php"><button class="circular-button" style="background-color: #FFFFEB; font-size: 20px;">agregar al carrito</button></a>
                </div>
            </div>
        </div>
    </div><br>
